...
//public class FlightWindFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
//
//    //draws effects required for flight spells.
//    //added using the PlayerEntityRendererMixin
//
//
//
...
//
//    public FlightWindFeatureRenderer(FeatureRendererContext<T, M> context, EntityModelLoader loader) {
//        super(context);
...
//        if (itemStack.isOf(Items.LEATHER_CHESTPLATE)) {
